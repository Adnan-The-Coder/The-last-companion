    ...
    <div className="flex min-h-screen flex-col justify-center overflow-hidden bg-gradient-to-b from-[#2D3142] to-[#4F5D75] py-12 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="mt-2 text-center text-sm text-[#4F5D75]">
          Or{' '}
          <Link href="/auth/signup" className="font-medium text-[#EF8354] transition-colors duration-300 hover:text-[#D64C1B]">
      ...
      >
        <motion.div 
          className="rounded-lg bg-white px-4 py-8 shadow-xl sm:px-10"
        ...
        >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1">
                <motion.input
                  ...
                  className="block w-full appearance-none rounded-md border border-[#BFC0C0]/30 px-3 py-2 text-black placeholder-[#4F5D75]/50 shadow-sm transition-colors duration-200 focus:border-[#EF8354] focus:outline-none focus:ring-[#EF8354] sm:text-sm"
            ...
            <motion.button
              type="submit"
              className="flex w-full justify-center rounded-md border border-transparent bg-[#EF8354] px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors duration-200 hover:bg-[#EF8354]/90 focus:outline-none focus:ring-2 focus:ring-[#EF8354] focus:ring-offset-2"
