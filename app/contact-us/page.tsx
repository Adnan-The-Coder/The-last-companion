...
export default function ContactUsPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-white to-[#F5F5F7] min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-[#2D3142] text-white">
        ...
        <div className="container mx-auto px-4 py-16 sm:py-24 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Contact <span className="text-[#EF8354]">Us</span></h1>
            <p className="text-lg text-[#BFC0C0] mb-8">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-serif font-bold text-[#2D3142] mb-6">Get in Touch</h2>
              ...
              <div className="space-y-6 p-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-[#EF8354]/10 p-3 rounded-full mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#EF8354]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div>
                    ...
                    <a href="tel:+18001234567" className="text-[#EF8354] font-medium hover:text-[#D64C1B] transition-colors duration-200">+1 (800) 123-4567</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@lastcompanion.com" className="text-[#EF8354] font-medium hover:text-[#D64C1B] transition-colors duration-200">info@lastcompanion.com</a>
                  </div>
                </div>
              ...
              <div className="mt-10">
                <h3 className="text-lg font-medium text-[#2D3142] mb-4">Hours of Operation</h3>
                <div className="bg-white rounded-lg shadow-sm p-4">
                  ...
                  <div className="mt-3 pt-3 border-t border-[#BFC0C0]/30 text-[#2D3142] font-medium">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
                {submitted ? (
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-medium text-[#2D3142] mb-2">Thank You</h3>
                    <p className="text-[#4F5D75] mb-6">
                      Your message has been sent successfully. We'll get back to you as soon as possible.
                    </p>
                    <button
                      onClick={() => setSubmitted(false)}
                      className="inline-flex items-center text-[#EF8354] font-medium hover:text-[#D64C1B] transition-colors duration-200"
                    >
                  ...
                  <>
                    <h2 className="text-2xl font-serif font-bold text-[#2D3142] mb-6">Send Us a Message</h2>
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div>
                        <label htmlFor="name" className="block text-sm font-medium text-[#2D3142] mb-1">
                          Full Name
                        </label>
                        <motion.input
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          <label htmlFor="email" className="block text-sm font-medium text-[#2D3142] mb-1">
                            Email Address
                          </label>
                          <motion.input
                            whileFocus={{ scale: 1.01 }}
                        ...
                        <div>
                          <label htmlFor="phone" className="block text-sm font-medium text-[#2D3142] mb-1">
                            Phone Number
                          </label>
                          <motion.input
                            whileFocus={{ scale: 1.01 }}
                      ...
                      <div>
                        <label htmlFor="message" className="block text-sm font-medium text-[#2D3142] mb-1">
                          Message
                        </label>
                        <motion.textarea
                          whileFocus={{ scale: 1.01 }}
                      ...
                      <motion.button
                        ...
                        type="submit"
                        disabled={loading}
                        className="w-full bg-[#EF8354] text-white py-3 px-4 rounded-md font-medium hover:bg-[#D64C1B] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#EF8354] transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {loading ? (
      ...
      <section className="container mx-auto px-4 py-12 mb-16">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-serif font-bold text-[#2D3142] mb-4">Find Us</h2>
          ...
          >
            ...
            <div className="relative flex h-40 items-center justify-center bg-gradient-to-r from-[#EF8354] to-[#EF8354]/80">
              <div className="mb-12 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-[#4F5D75]/50 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
