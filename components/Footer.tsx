    ...
    <footer className="bg-[#2D3142] text-white">
      ...
      <div className="relative overflow-hidden bg-[#1A1D2A] py-8">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="arabic-quote relative mb-2 text-3xl text-[#EF8354]">
              إِنَّا لِلَّهِ وَإِنَّا إِلَيْهِ رَاجِعُونَ
            </p>
          </div>
          <p 
            className="mx-auto max-w-2xl text-xl italic text-[#BFC0C0]"
          ...
          <p 
            className="mt-2 text-sm text-[#4F5D75]"
      ...
      <div className="border-t border-[#4F5D75]/30 bg-[#1A1D2A] py-6">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-2 font-arabic text-sm text-[#4F5D75]">إِنَّا لِلَّهِ وَإِنَّا إِلَيْهِ رَاجِعُونَ</p>
        </div>
      </div>
    </footer>
  );
