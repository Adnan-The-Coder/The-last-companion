export const EMAIL_TEMPLATES = {
  ...
  SERVICE_BOOKING: `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #2D3142;">
      ...
      <p>Assalamu Alaikum {user},</p>
      <p>This email confirms your booking for {serviceName} with The Last Companion.</p>
      <div style="background-color: #F5F5F7; padding: 20px; margin: 20px 0; border-radius: 8px;">
        <h3 style="color: #EF8354; margin-top: 0;">Booking Details:</h3>
        <p>Service: {serviceName}</p>
        <p>Date: {date}</p>
        <p>Time: {time}</p>
        <p>Location: {location}</p>
      </div>
      <p>Our team will contact you shortly to discuss the arrangements in detail.</p>
      <p>For urgent matters, please call us at: <strong>+91 9618316290</strong></p>
